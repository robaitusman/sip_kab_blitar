    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Publikasi Pangan</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="publikasipangan-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('publikasipangan.store') }}" method="post">
                            @csrf
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-gambar-holder" class=" ">
                                                <div class="dropzone required" input="#ctrl-gambar" fieldname="gambar" uploadurl="{{ url('fileuploader/upload/gambar') }}"    data-multiple="false" dropmsg="Choose files or drop files here"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                    <input name="gambar" id="ctrl-gambar" data-field="gambar" required="" class="dropzone-input form-control" value="<?php echo get_value('gambar') ?>" type="text"  />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-tahun-holder" class="input-group ">
                                                <input id="ctrl-tahun" data-field="tahun" class="form-control datepicker  datepicker"  required="" value="<?php echo get_value('tahun', date('Y-m-d', strtotime('+1month'))) ?>" type="datetime" name="tahun" placeholder="Enter Tahun" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
